...
export default function AddFoodCard({ onClick }: AddFoodCardProps) {
  return (
    ...
    >
      <CardLayout className="h-full min-h-[280px] sm:min-h-[320px] items-center justify-center border-dashed bg-transparent hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors cursor-pointer active:scale-[0.98]">
