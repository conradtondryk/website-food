...
export default function AddFoodCard({ onClick }: AddFoodCardProps) {
  return (
    ...
    >
      <CardLayout className="h-full min-h-[320px] items-center justify-center border-dashed border-2 hover:border-zinc-400 dark:hover:border-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-all cursor-pointer">
        <div className="flex flex-col items-center justify-center text-zinc-400 dark:text-zinc-500 group-hover:text-zinc-600 dark:group-hover:text-zinc-300 transition-colors">
          ...
          <span className="text-sm sm:text-base font-medium text-center">Add Food to Compare</span>
        </div>
      </CardLayout>
    </button>
  );
